...
int JUDGE(int turn, int player[3]){
    ...
    int a = 0;
    _Bool win = 0;
    if (arr[0]==1 && arr[1]==2 && arr[2]==3) win = 1;
    else if (arr[0]==4 && arr[1]==5 && arr[2]==6) win = 1;
    else if (arr[0]==7 && arr[1]==8 && arr[2]==9) win = 1;
    else if (arr[0]==1 && arr[1]==4 && arr[2]==7) win = 1;
    else if (arr[0]==2 && arr[1]==5 && arr[2]==8) win = 1;
    else if (arr[0]==3 && arr[1]==6 && arr[2]==9) win = 1;
    else if (arr[0]==1 && arr[1]==5 && arr[2]==9) win = 1;
    else if (arr[0]==3 && arr[1]==5 && arr[2]==7) win = 1;
    if (win == 1){
        if (turn == 0) a = 1;
        else if (turn == 1) a = 2;
    }
